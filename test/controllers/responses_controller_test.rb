...
class ResponsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create response" do
    assert_difference('Response.count') do
      post responses_url, params: { response: { answer_text: @response.answer_text, survey_id: @response.survey_id } }
    end
  ...
  test "should update response" do
    patch response_url(@response), params: { response: { answer_text: @response.answer_text, survey_id: @response.survey_id } }
